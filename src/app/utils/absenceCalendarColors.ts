...
const DEFAULT_ABSENCE_COLOR: AbsenceColorConfig = {
  ...
  leaveCellClass: "bg-blue-50 text-blue-700 font-semibold border-r border-blue-200",
  workhourCellClass: "bg-blue-50 text-blue-700",
  workhourTopBarClass: "!bg-blue-500/30 !text-blue-200",
  workhourBottomBarBgClass: "bg-blue-50 text-blue-700",
...
const ABSENCE_COLORS: Record<CalendarAbsenceType, AbsenceColorConfig> = {
  VACATION: {
    ...
    leaveCellClass: "bg-teal-50 text-teal-700 font-semibold border-r border-teal-200",
    workhourCellClass: "bg-teal-50 text-teal-700",
    workhourTopBarClass: "!bg-teal-500/30 !text-teal-200",
    workhourBottomBarBgClass: "bg-teal-50 text-teal-700",
    workhourBottomBarBorderClass: "border-teal-400",
  },
  SICK: {
    legendChipClass: "bg-rose-50 text-rose-700 border border-rose-200",
    leaveCellClass: "bg-rose-50 text-rose-700 font-semibold border-r border-rose-200",
    workhourCellClass: "bg-rose-50 text-rose-700",
    workhourTopBarClass: "!bg-rose-500/30 !text-rose-200",
    workhourBottomBarBgClass: "bg-rose-50 text-rose-700",
    workhourBottomBarBorderClass: "border-rose-400",
  },
  PERSONAL: {
    legendChipClass: "bg-violet-50 text-violet-700 border border-violet-200",
    leaveCellClass: "bg-violet-50 text-violet-700 font-semibold border-r border-violet-200",
    workhourCellClass: "bg-violet-50 text-violet-700",
    workhourTopBarClass: "!bg-violet-500/30 !text-violet-200",
    workhourBottomBarBgClass: "bg-violet-50 text-violet-700",
    workhourBottomBarBorderClass: "border-violet-400",
  },
  PARENTAL: {
    legendChipClass: "bg-amber-50 text-amber-700 border border-amber-200",
    leaveCellClass: "bg-amber-50 text-amber-700 font-semibold border-r border-amber-200",
    workhourCellClass: "bg-amber-50 text-amber-700",
    workhourTopBarClass: "!bg-amber-500/30 !text-amber-200",
    workhourBottomBarBgClass: "bg-amber-50 text-amber-700",
    workhourBottomBarBorderClass: "border-amber-400",
  },
  MARRIAGE: {
    legendChipClass: "bg-fuchsia-50 text-fuchsia-700 border border-fuchsia-200",
    leaveCellClass: "bg-fuchsia-50 text-fuchsia-700 font-semibold border-r border-fuchsia-200",
    workhourCellClass: "bg-fuchsia-50 text-fuchsia-700",
    workhourTopBarClass: "!bg-fuchsia-500/30 !text-fuchsia-200",
    workhourBottomBarBgClass: "bg-fuchsia-50 text-fuchsia-700",
    workhourBottomBarBorderClass: "border-fuchsia-400",
  },
  BEREAVEMENT: {
    legendChipClass: "bg-slate-100 text-slate-700 border border-slate-200",
    leaveCellClass: "bg-slate-100 text-slate-700 font-semibold border-r border-slate-200",
    workhourCellClass: "bg-slate-100 text-slate-700",
    workhourTopBarClass: "!bg-slate-500/30 !text-slate-200",
    workhourBottomBarBgClass: "bg-slate-100 text-slate-700",
...
export const WEEKEND_CALENDAR_COLORS = {
  ...
  leaveCellClass: "bg-slate-50 text-slate-600 border-r border-slate-200",
...
export const PENDING_CALENDAR_COLORS = {
  ...
  leaveCellClass: "bg-yellow-50 text-yellow-700 font-semibold border-r border-yellow-200",
};
