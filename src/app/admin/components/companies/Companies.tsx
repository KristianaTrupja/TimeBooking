    ...
    <section className="p-6 h-full flex flex-col overflow-y-auto custom-scrollbar">
      ...
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-900">{t.companyManagement}</h1>
            <p className="text-sm text-slate-600">{t.companiesDescription}</p>
          </div>
        </div>
          ...
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm">
            <div className="p-4 border-b border-slate-200">
              <h3 className="text-sm font-semibold text-slate-700">
                {t.activeCompanies} ({activeCompanies.length})
              </h3>
            </div>
        ...
        <div className="w-full lg:w-1/3">
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5 sticky top-0">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="text-lg font-bold text-slate-900">{t.newCompany}</h3>
                <p className="text-sm text-slate-600">{t.addCompany}</p>
              </div>
            </div>
